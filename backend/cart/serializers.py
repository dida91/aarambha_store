...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CartItem
        fields = ['id', 'product', 'product_name', 'product_price', 'quantity', 'line_total', 'updated_at']
        read_only_fields = ['id', 'updated_at', 'product_name', 'product_price', 'line_total']
    ...
    def validate(self, attrs):
        ...
        if quantity > product.stock:
            raise serializers.ValidationError({'quantity': 'Requested quantity exceeds stock.'})
